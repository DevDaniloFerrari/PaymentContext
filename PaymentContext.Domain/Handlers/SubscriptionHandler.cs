...
namespace PaymentContext.Domain.Handlers
{
    public class SubscriptionHandler :
        ...
        IHandler<CreatePayPalSusbcriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubcriptionCommand command)
        {
            ...
            var payment = new BoletoPayment(
                ...
                command.TotalPaid,
                command.Payer,
                new Document(command.PayerDocument, command.PaymerDocumentType),
                address, email
            );
        ...
        public ICommandResult Handle(CreatePayPalSusbcriptionCommand command)
        {
            // Verificar se Documento já está cadastrado
            if (_repository.DocumentExists(command.Document))
                AddNotification("Document", "Este CPF já está em uso");
